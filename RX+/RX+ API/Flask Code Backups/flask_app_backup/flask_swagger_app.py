...
@name_space3.route('/api/summary')
class path_seg_summary(Resource):
    def get(self):
        x = get_path_seg_summary()
        headers = {'Content-Type': 'text/html'}
        return make_response(render_template('index.html', title="page"),200,headers)
